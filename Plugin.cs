...
public class Plugin : LabApi.Loader.Features.Plugins.Plugin<Config>
{
    ...
    public override void Enable()
    {
        ...
        Log.Info($"SLDataAPI v{Version} (Rebirth / LabAPI) enabled. HTTP on port {Config.HttpPort}. Control API: {(Config.ControlEnabled ? $"{Config.ControlTransport.ToUpperInvariant()} 模式" : "关闭")}. Voice: {(Config.VoiceEnabled ? $"启用(端口 {Config.VoicePort})" : "关闭")}.");
    }
