...
**产品版本是 2.6.0 PEAK**（自 `preview/v2.6.0-DevOnly` 合入 `main`）。

📚 **接口与开发文档：** https://github.com/DNTOF/SLDataAPI/wiki  
- 本版本（2.6.0 PEAK / `main`）：[[Preview-HTTP-API]](https://github.com/DNTOF/SLDataAPI/wiki/Preview-HTTP-API) · API Key + RA 对齐路径  
- 上一稳定线 2.5.x：[[HTTP-API]](https://github.com/DNTOF/SLDataAPI/wiki/HTTP-API) · `control_token`
...
路径与 curl 示例：Wiki [[Preview-HTTP-API]](https://github.com/DNTOF/SLDataAPI/wiki/Preview-HTTP-API)。2.5.x 仍用 [[HTTP-API]](https://github.com/DNTOF/SLDataAPI/wiki/HTTP-API)（`control_token`）。
